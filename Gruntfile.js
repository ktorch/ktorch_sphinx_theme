module.exports = function(grunt) {
  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'ktorch_sphinx_theme/static/fonts/FreightSans',
              filter: 'isFile'
          },

          {
              ...
              dest: 'ktorch_sphinx_theme/static/fonts/IBMPlexMono',
              filter: 'isFile'
          }
        ]
      },
        ...
        files: [
          {
              ...
              flatten: true,
              src: ['images/*'],
              dest: 'ktorch_sphinx_theme/static/images',
              filter: 'isFile'
          }
        ]
      },
      ...
      vendor: {
        files: [
...

          {
            ...
            dest: 'ktorch_sphinx_theme/static/js/vendor',
            filter: 'isFile'
          }
        ]
      }
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'scss',
          src: ['*.scss'],
          dest: 'ktorch_sphinx_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    postcss: {
      ...
      dist: {
        files: {
          "ktorch_sphinx_theme/static/css/theme.css": "ktorch_sphinx_theme/static/css/theme.css"
        }
      }
    },
    ...
    browserify: {
      dev: {
        options: {
          external: ['jquery'],
          alias: {
            'ktorch-sphinx-theme': './js/theme.js'
          }
        },
        src: ['js/*.js'],
        dest: 'ktorch_sphinx_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    uglify: {
      dist: {
        ...
        files: [{
          expand: true,
          src: ['ktorch_sphinx_theme/static/js/*.js', '!ktorch_sphinx_theme/static/js/*.min.js'],
          dest: 'ktorch_sphinx_theme/static/js/',
    ...
    clean: {
      build: ["docs/build"],
      fonts: ["ktorch_sphinx_theme/static/fonts"],
      images: ["ktorch_sphinx_theme/static/images"],
      css: ["ktorch_sphinx_theme/static/css"],
      js: ["ktorch_sphinx_theme/static/js/*", "!ktorch_sphinx_theme/static/js/modernizr.min.js"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['ktorch_sphinx_theme/**/*', 'README.rst', 'docs/**/*.rst', 'docs/**/*.py'],
